...
class Config:
    ...
    DATA_PATH = "Dynamic_Interview/interview_data.csv"
    TRAINED_MODEL_PATH = "Dynamic_Interview/Models/saved_llm_model.pkl"
    PROCESSED_DATA_PATH = "Dynamic_Interview/Models/processed_interview_dataset.pkl"
